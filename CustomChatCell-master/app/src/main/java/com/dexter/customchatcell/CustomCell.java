...
//        pathPaint.setStyle(Paint.Style.FILL_AND_STROKE);// set the size
        pathPaint.setDither(true);                    // set the dither to true
        pathPaint.setStyle(Paint.Style.STROKE);       // set to STOKE// set the paint cap to round too
        ...
        if (messageType==MediaType.TEXT) {
            if (senderType == SELF) {
                path.moveTo(0+offset,height);
                path.lineTo(width-offset*2,height);
                path.lineTo(0,height);
                path.moveTo(0,height);
                path.lineTo(0,0+offset);
                path.moveTo(width-offset*2,height);
               ...
               // path.moveTo(0,0+offset);
                ...
                path.moveTo(0+offset,0);
                path.lineTo(width+offset,0);
                //path.moveTo(width+offset,0);
                path.moveTo(width-offset,0+offset);
                path.lineTo(width+offset,0-offset);
               // path.moveTo(0+offset,height);
                path.close();
            } else {
